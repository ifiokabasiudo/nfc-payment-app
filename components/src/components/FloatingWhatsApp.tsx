...
const darkBG = "/assets/bg-chat-tile-light.png";
const lightBG = "/assets/bg-chat-tile-dark.png";
const dummyAvatar = "/assets/uifaces-avatar.jpg";
const SoundBeep = "/assets/whatsapp-notification.mp3";
